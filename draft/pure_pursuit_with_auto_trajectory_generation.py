...
from generate_path_omit_regulation import generate_path # function for auto-path generation
...
def generate_waypoints(env, start, end, constant_speed):
    ...
    trajectory = generate_path(env,start_waypoint, end_waypoint, waypoint_separation = 10)

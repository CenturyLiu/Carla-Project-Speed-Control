        ...
        if end_of_search(current_w, destination, waypoint_separation):
            ...
            if display_trajectory:
                ...
                for ii in range(1,len(trajectory)):
                    ...
                    env.world.debug.draw_arrow(loc1, loc2, thickness=1.0, arrow_size=1.0, color = green, life_time=0.0, persistent_lines=True)
            break
...
def main():
    try:
        ...
        destination_raw = carla.Location(x=-9.0, y=100.0, z=0.0)
